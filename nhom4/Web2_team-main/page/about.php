                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="mens-toolbar">
                             ...
                             <ul id="pagination" class="women_pagenation dc_paginationA dc_paginationA06">
...
<script>
    $.get('../pagination_ajax.php',{
        trangHienTai: <?php echo $trangHienTai;?>,
        hanhDong: 'about',
        loaiSanPham: ''
    }, function(data){
    ...
    function Timkiem(){
        window.location.href='./index.php?action=about&timkiem=&giacantim='
        return false;
    }
</script>
